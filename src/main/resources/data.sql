...
INSERT INTO accounts (account_id, identity_id, trader_number)
VALUES
('9c3627e7-d5be-4f7e-8e52-4b7fca97d0a0', '123e4567-e89b-12d3-a456-426655440000', 'ABC-01-2023-123');

INSERT INTO transactions (transaction_number, account_id, transaction_type, fund_value, fund_currency, transaction_date)
VALUES
('f49c5c94-3b0e-467c-94c1-2b8356db8cfa', '9c3627e7-d5be-4f7e-8e52-4b7fca97d0a0', 'CARD', 100.00, 'PLN', CURRENT_TIMESTAMP);

INSERT INTO wallets (wallet_id, account_id, fund_value, fund_currency)
VALUES
